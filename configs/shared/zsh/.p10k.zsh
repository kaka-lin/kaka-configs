# Generated by Powerlevel10k configuration wizard on 2023-04-17 at 14:37 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=0 # black
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND='yellow'     # 2
